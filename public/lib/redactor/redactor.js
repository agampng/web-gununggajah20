...
(function($)
{
    ...
    $.Redactor.opts = {
        ...
        blockTags: ['pre', 'ul', 'ol', 'li', 'p', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6',  'dl', 'dt', 'dd', 'div', 'td', 'blockquote', 'output', 'figcaption', 'figure', 'address', 'section', 'header', 'footer', 'aside', 'artikel', 'iframe'],
        paragraphize: true,
        paragraphizeBlocks: ['table', 'div', 'pre', 'form', 'ul', 'ol', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'dl', 'blockquote', 'figcaption',
            'address', 'section', 'header', 'footer', 'aside', 'artikel', 'object', 'style', 'script', 'iframe', 'select', 'input', 'textarea',
        ...
        image: function()
        {
            return {
                ...
                moveResize: function(e)
                {
                    ...
                    $('#redactor-image-dimension').html(parseInt(width)+'x'+parseInt(height));
                ...
                hideResize: function(e)
                {
                    ...
                    $('#redactor-image-dimension').remove();
                ...
                loadResizableControls: function($image, imageBox)
                {
                    if (this.opts.imageResizable && !this.detect.isMobile())
                    {
                        ...
                        var imageDimension = $('<span id="redactor-image-dimension"></span>');

                        imageDimension.html(parseInt($image.width())+'x'+parseInt($image.height()));
                        ...
                        imageBox.append(imageDimension);
                ...
                showEdit: function($image)
                {
                    ...
                    $('#redactor-image-width').val(parseInt($image.width()));
        ...
        observe: function()
        {
            return {
                ...
                showTooltip: function(e)
                {
                    ...
                    if (parseInt(tooltip.css('right')) < 0) {
                        tooltip.css({
                            left: (pos.left - tooltip.width()) + 'px'
                        });
                    }
